...
3. `ssp_orf6_trans_trans_15deg` contains the output from the secondary structure propensity algorithm (1) for the trans-P57 Calpha, Cbeta, and Halpha chemical shifts at 288 K. The subdirectory contains the data and scripts for you to repeat the analysis. The `ssp-orf6-ctr-288K-trans.txt` was used in the Jupyter notebook to produce the manuscript figure. 
